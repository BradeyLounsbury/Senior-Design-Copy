...
const EULA = () => {
  return (
    <div className={styles["EULA-wrap"]}>
        ...
        <p>Please read this End-User License Agreement carefully before clicking the &quot;I Agree&quot; button, downloading or using Event Planner.</p>
        ...
        <ul>
        <li>
        <p><strong>Agreement</strong> means this End-User License Agreement that forms the entire agreement between You and the Company regarding the use of the Application. This Agreement has been created with the help of the <a href="https://www.termsfeed.com/eula-generator/" target="_blank">TermsFeed EULA Generator</a>.</p>
        </li>
        <li>
        <p><strong>Application</strong> means the software program provided by the Company downloaded by You to a Device, named Event Planner</p>
        </li>
        <li>
        <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Event Planner.</p>
        </li>
        <li>
        ...
        <ul>
        <li>By visiting this page on our website: <a href="https://ctat.gkplanner.com/" rel="external nofollow noopener" target="_blank">https://ctat.gkplanner.com/</a></li>
        </ul>
    </div>
  );
}
